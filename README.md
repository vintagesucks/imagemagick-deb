...
```sh
$ magick --version
Version: ImageMagick 7.1.2-12 Q16-HDRI x86_64 2c08c2311:20251227 https://imagemagick.org
...
-------------------------------------------------------------------------------
   ...
   ASHLAR* ASHLAR    -w+   Image sequence laid out in continuous irregular courses
     AVCI  HEIC      ---   AVC Image File Format (1.21.1)
      AVI  VIDEO     r--   Microsoft Audio/Visual Interleaved
     AVIF  HEIC      rw+   AV1 Image File Format (1.21.1)
 ...
 GRADIENT* GRADIENT  r--   Gradual linear passing from one shade to another
   ...
   GROUP4* TIFF      rw-   Raw CCITT Group4
     ...
     HEIC  HEIC      rw+   High Efficiency Image Format (1.21.1)
     HEIF  HEIC      rw+   High Efficiency Image Format (1.21.1)
