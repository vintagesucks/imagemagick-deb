...
```sh
$ magick --version
Version: ImageMagick 7.1.0-61 Q16-HDRI x86_64 6b11831de:20230205 https://imagemagick.org
...
-------------------------------------------------------------------------------
 ...
 GRADIENT* GRADIENT  r--   Gradual linear passing from one shade to another
   ...
   GROUP4* TIFF      rw-   Raw CCITT Group4
     ...
     HEIC  HEIC      rw+   High Efficiency Image Format (1.14.2)
     HEIF  HEIC      rw+   High Efficiency Image Format (1.14.2)
