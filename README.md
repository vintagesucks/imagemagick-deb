...
```sh
$ magick --version
Version: ImageMagick 7.1.2-10 Q16-HDRI x86_64 69f7ced59:20251206 https://imagemagick.org
...
-------------------------------------------------------------------------------
   ...
   ASHLAR* ASHLAR    -w+   Image sequence laid out in continuous irregular courses
     AVCI  HEIC      ---   AVC Image File Format (1.20.2)
      AVI  VIDEO     r--   Microsoft Audio/Visual Interleaved
     AVIF  HEIC      rw+   AV1 Image File Format (1.20.2)
 ...
 GRADIENT* GRADIENT  r--   Gradual linear passing from one shade to another
   ...
   GROUP4* TIFF      rw-   Raw CCITT Group4
     ...
     HEIC  HEIC      rw+   High Efficiency Image Format (1.20.2)
     HEIF  HEIC      rw+   High Efficiency Image Format (1.20.2)
