...
```sh
$ magick --version
Version: ImageMagick 7.1.1-2 Q16-HDRI x86_64 f41f852be:20230309 https://imagemagick.org
...
-------------------------------------------------------------------------------
 ...
 GRADIENT* GRADIENT  r--   Gradual linear passing from one shade to another
   ...
   GROUP4* TIFF      rw-   Raw CCITT Group4
     ...
     HEIC  HEIC      rw+   High Efficiency Image Format (1.15.1)
     HEIF  HEIC      rw+   High Efficiency Image Format (1.15.1)
