...
```sh
$ magick --version
Version: ImageMagick 7.1.1-21 Q16-HDRI x86_64 dcffc2de3:20231021 https://imagemagick.org
...
-------------------------------------------------------------------------------
   ...
   ASHLAR* ASHLAR    -w+   Image sequence laid out in continuous irregular courses
     ...
     AVIF  HEIC      rw+   AV1 Image File Format (1.17.5)
 ...
 GRADIENT* GRADIENT  r--   Gradual linear passing from one shade to another
   ...
   GROUP4* TIFF      rw-   Raw CCITT Group4
     ...
     HEIC  HEIC      rw+   High Efficiency Image Format (1.17.5)
     HEIF  HEIC      rw+   High Efficiency Image Format (1.17.5)
